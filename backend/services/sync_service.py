...
from repositories.sync_repository import sync_mutations_to_database, sync_seamen_to_database
from scripts.scheduler import fetch_mutations_from_original_api, fetch_seamen_from_original_api
...
def manual_sync():
    ...
    try:
        ...
        if seamen_df is not None:
            ...
            print("[MANUAL SYNC] Failed to fetch seamen data")
        ...
        if mutations_df is not None:
            ...
            print("[MANUAL SYNC] Failed to fetch mutations data")
